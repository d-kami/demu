...
public class Mod1RM3 implements RMReturn{
    public RM getRM(VM vm){
        if(vm.is32bitAddress()){
            return new Memory32(vm, vm.getSegmentAddress(vm.getSegmentIndex()), (int)(vm.getRegister32(EBX) + vm.getSignedCode8(2)), 1);
        }else{
            return new Memory16(vm, vm.getSegmentAddress(SS), vm.getRegister16(EBP) + vm.getRegister16(EDI) + vm.getSignedCode8(2), 1);
        }
    }
}