...
public class Mod2RM2 implements RMReturn{
    public RM getRM(VM vm){
        if(vm.is32bitAddress()){
            return new Memory32(vm, vm.getSegmentAddress(vm.getSegmentIndex()), (int)vm.getRegister32(EDX) + vm.getSignedCode32(2), 4);
        }else{
            return new Memory16(vm, vm.getSegmentAddress(SS) + vm.getRegister16(EBP), vm.getRegister16(ESI) + vm.getSignedCode16(2), 2);
        }
    }
}