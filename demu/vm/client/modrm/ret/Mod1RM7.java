...
public class Mod1RM7 implements RMReturn{
    public RM getRM(VM vm){
        if(vm.is32bitAddress()){
            return new Memory32(vm, vm.getSegmentAddress(vm.getSegmentIndex()), (int)(vm.getRegister32(EDI) + vm.getSignedCode8(2)), 1);
        }else{
            return new Memory16(vm, vm.getSegmentAddress(vm.getSegmentIndex()), vm.getRegister16(EBX) + vm.getCode8(2), 1);
        }
    }
}